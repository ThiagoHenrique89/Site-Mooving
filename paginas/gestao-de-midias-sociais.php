...
<div class="coluna esquerda">
                <nav class="breadcrumb">
                    <a href="/">Home</a> > <span>Gestão de Mídias Sociais</span>
                </nav>
<h1 class="mbz tituloServicos">Gestão de Mídias Sociais para Empresas em Jundiaí</h1>
</div>
<div class="coluna direita">
<p>A <strong>Mooving</strong> é sua agência de <strong>gestão de mídias sociais em Jundiaí</strong>, focada em transformar os perfis da sua empresa em canais de relacionamento, autoridade e, principalmente, vendas. Vamos além da publicação de posts, com um planejamento estratégico que conecta sua marca ao público certo, gerando resultados mensuráveis. De <em>estratégia de conteúdo</em> a <em>gerenciamento de anúncios</em>, nosso objetivo é fortalecer sua presença digital na cidade e região.</p>
</div>
</div>
</div>
</header>
...
<p>As redes sociais são a principal forma de interação do público com as marcas hoje. Ter uma presença ativa e estratégica é crucial para construir uma comunidade leal, aumentar a visibilidade, gerar tráfego qualificado para o seu site e converter seguidores em clientes. Empresas de Jundiaí que investem em <strong>gestão de mídias sociais</strong> saem na frente da concorrência.</p>
        ...
        <p>Usamos ferramentas de análise para monitorar o desempenho de cada campanha e post. Com relatórios detalhados, você acompanha o crescimento do seu perfil, o engajamento do público e o impacto das nossas ações no seu negócio.</p>

        <h2>Nosso Processo de Gestão de Mídias Sociais</h2>
        <h3>Análise Estratégica</h3>
        <p>Estudamos seu público, concorrentes e objetivos para traçar a melhor rota. Definimos os pilares de conteúdo, tom de voz e métricas de sucesso.</p>

        <h3>Criação e Aprovação</h3>
        <p>Criamos o calendário de posts e os criativos (arte e texto) para sua aprovação. Garantimos que o conteúdo esteja alinhado com a sua marca e seja otimizado para as plataformas.</p>
